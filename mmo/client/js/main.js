...
import {createResourceInteraction} from './resource/resource-interaction-v2.js?v=20260915-1';
...
const canvas=document.querySelector('#game');const ctx=canvas?.getContext('2d');const debugToggle=document.querySelector('#debug-toggle');const interactHint=document.querySelector('#npc-interact');
let npcInteraction=null,resourceInteraction=null,deliveryInteraction=null,craftingInteraction=null;
...
const {assets,ready}=loadAssets();let last=performance.now();
